export function createSystemMessages (downloadRes) {
  const body = document.querySelector('body');
  const successTemplate = document.querySelector(`#${downloadRes}`).content.cloneNode(true);
  const message = document.querySelector(`.${downloadRes}`);
